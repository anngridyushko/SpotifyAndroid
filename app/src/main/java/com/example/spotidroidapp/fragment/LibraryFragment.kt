...
import com.example.spotidroidapp.databinding.FragmentLibraryBinding
...
class LibraryFragment : Fragment(R.layout.fragment_library), OnSongClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = GenreSongViewModelFactory(SongRepository(token)).create(GenreSongViewModel::class.java)
